...
def check_casenone():
    ...
    for i in modetest:
        ...
        if i == "0":
            ...
            print("Số case trống luồng full: ", count)
        ...
        if i == "1":
            ...
            print(list_casefail)
            count = len(list_casefail)
            print("Số case trống luồng khách hàng(1): ", count)
            module_other_stx_app.writeData1(var_stx_app.path_luutamthoi, "Sheet1", 86, 2, count)
        ...
        if i == "2":
            ...
            print(list_casefail)
            count = len(list_casefail)
            print("Số case trống luồng xế(3): ", count)
            module_other_stx_app.writeData1(var_stx_app.path_luutamthoi, "Sheet1", 86, 2, count)
...
def check_casefail():
    ...
    for i in modetest:
        ...
        if i == "1":
            ...
            print(list_casefail)
            count = len(list_casefail)
            print("Số case fail luồng khách hàng(1): ", count)
            module_other_stx_app.writeData1(var_stx_app.path_luutamthoi, "Sheet1", 167, 2, count)
        ...
        if i == "2":
            ...
            print(list_casefail)
            count = len(list_casefail)
            print("Số case fail luồng xê(3): ", count)
            module_other_stx_app.writeData1(var_stx_app.path_luutamthoi, "Sheet1", 167, 2, count)
...
def check_casepass():
    ...
    for i in modetest:
        ...
        if i == "1":
            ...
            print(list_casefail)
            count = len(list_casefail)
            print("Số case pass luồng khách(1): ", count)
            module_other_stx_app.writeData1(var_stx_app.path_luutamthoi, "Sheet1", 177, 2, count)
        ...
        if i == "2":
            ...
            print(list_casefail)
            count = len(list_casefail)
            print("Số case pass luồng xế(3): ", count)
            module_other_stx_app.writeData1(var_stx_app.path_luutamthoi, "Sheet1", 177, 2, count)
